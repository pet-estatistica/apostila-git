...
\begin{wrapfigure}{r}{0.4\textwidth}
   ...
   \end{center}
   \caption{Colaborador solicita merge, e aguarda revisão dos demais
      colaboradores.}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
   \begin{center}
      \includegraphics[width=2.5cm]{./images/traba-git-1.png}
   \end{center}
...
\begin{wrapfigure}{r}{0.4\textwidth}
  \begin{center}
    \includegraphics[width=6cm]{./images/traba-forking-1.png}
  \end{center}
